...
//////////////////////////////////////////////////////////////////////
// Cast implementations for i32
//////////////////////////////////////////////////////////////////////

impl TryCast<u8> for i32 {
...
impl TryCast<i8> for i32 {
    fn try_cast(&self) -> Result<i8, CastError> {
        if *self < i8::MIN as i32 || *self > i8::MAX as i32 {
            return Err(CastError::Overflow);
        }
        Ok(*self as i8)
    }
...
impl TryCast<u16> for i32 {
    fn try_cast(&self) -> Result<u16, CastError> {
        if *self < 0 || *self > u16::MAX as i32 {
            return Err(CastError::Overflow);
        }
        Ok(*self as u16)
    }
...
impl TryCast<i64> for i32 {
    fn try_cast(&self) -> Result<i64, CastError> {
        Ok(*self as i64)
    }
}

impl TryCast<u64> for i32 {
...
impl TryCast<f32> for i32 {
    fn try_cast(&self) -> Result<f32, CastError> {
        Ok(*self as f32)
    }
}

impl TryCast<f64> for i32 {
...
//////////////////////////////////////////////////////////////////////
// Cast implementations for u32
//////////////////////////////////////////////////////////////////////

impl TryCast<u8> for u32 {
    fn try_cast(&self) -> Result<u8, CastError> {
...
impl TryCast<i64> for u32 {
    fn try_cast(&self) -> Result<i64, CastError> {
        Ok(*self as i64)
    }
}

impl TryCast<u64> for u32 {
    fn try_cast(&self) -> Result<u64, CastError> {
        Ok(*self as u64)
    }
}

impl TryCast<f32> for u32 {
    fn try_cast(&self) -> Result<f32, CastError> {
        Ok(*self as f32)
    }
}

impl TryCast<f64> for u32 {
    fn try_cast(&self) -> Result<f64, CastError> {
        Ok(*self as f64)
    }
}
